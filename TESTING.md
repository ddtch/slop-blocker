...
| `test/unit/site.test.ts` | The published site: sitemap against the pages that exist and their canonical tags, robots.txt, and that every favicon and og:image the markup promises is actually a file |
